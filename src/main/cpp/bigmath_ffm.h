...
BIGMATH_EXPORT void  bigint_init(mpz_ptr *out);
BIGMATH_EXPORT void  bigint_clear(mpz_ptr a);
BIGMATH_EXPORT void  bigint_set(mpz_ptr out, mpz_ptr a);
BIGMATH_EXPORT void  bigint_set_long(mpz_ptr out, int64_t val);
BIGMATH_EXPORT void  bigint_set_string(mpz_ptr out, const char *str, int radix);
...
BIGMATH_EXPORT void  bigint_mul_into(mpz_ptr out, mpz_ptr a, mpz_ptr b);
...
BIGMATH_EXPORT void   bigdecimal_set_double(mpfr_ptr out, double val);
BIGMATH_EXPORT void   bigdecimal_set_string(mpfr_ptr out, const char *str, int precision);
...
BIGMATH_EXPORT void   bigdecimal_div_into(mpfr_ptr out, mpfr_ptr a, mpfr_ptr b);
BIGMATH_EXPORT void   bigdecimal_sqrt_into(mpfr_ptr out, mpfr_ptr a);
